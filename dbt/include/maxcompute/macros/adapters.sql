...
{% macro maxcompute__create_schema(relation) -%}
...
{% macro maxcompute__drop_relation(relation) -%}
...
{% macro maxcompute__drop_schema(relation) -%}
...
{% macro maxcompute__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro maxcompute__list_schemas(database) -%}
